  ...
  return (
    <footer className="bg-gradient-to-br from-ocean-950 via-ocean-900 to-ocean-950 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0 bg-gradient-to-r from-algae-600/20 via-transparent to-teal-600/20"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-3xl font-bold text-white">
                Alga<span className="text-algae-400">E</span>arth
              </span>
            </div>
            ...
            <div className="flex items-center space-x-6">
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-ocean-800/70 flex items-center justify-center transition-all duration-300 group-hover:bg-algae-600/30 group-hover:shadow-lg">
          ...
          <div className="lg:col-span-2 grid grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/about" className="text-ocean-100 hover:text-algae-300 transition-colors">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/team" className="text-ocean-100 hover:text-algae-300 transition-colors">
                    Our Team
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-ocean-100 hover:text-algae-300 transition-colors">
                    Contact
                  </Link>
                </li>
              </ul>
