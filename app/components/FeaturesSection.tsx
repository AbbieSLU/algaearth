...
export default function FeaturesSection() {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-24 bg-gradient-to-br from-ocean-100 via-teal-100 to-algae-50">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16 reveal-on-scroll">
          <div className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 bg-algae-500/20 backdrop-blur-sm rounded-lg text-algae-700 text-xs sm:text-sm font-semibold mb-3 sm:mb-4 shadow-md">
            Key Advantages
          </div>
          <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-ocean-900 mb-3 sm:mb-4 tracking-tight px-4">
            Innovating for a Greener Tomorrow
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-ocean-700/90 max-w-3xl mx-auto leading-relaxed px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="reveal-on-scroll [perspective:1200px] h-[240px] sm:h-[280px] lg:h-[340px] group"
            ...
            >
              ...
              <div className="relative w-full h-full duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] transition-transform">
                ...
                <div className="absolute w-full h-full [backface-visibility:hidden]">
                  <div className="h-full p-4 sm:p-6 lg:p-8 bg-white/90 backdrop-blur-md rounded-lg sm:rounded-xl lg:rounded-2xl shadow-lg border border-teal-100/50 flex flex-col items-center justify-center group/card hover:shadow-xl transition-shadow duration-500">
                    {/* Icon Container with Gradient Background */}
                    <div className="relative mb-3 sm:mb-4 lg:mb-6 w-12 sm:w-14 lg:w-20 h-12 sm:h-14 lg:h-20">
                    ...
                    <h3 className="text-base sm:text-lg lg:text-xl font-bold text-ocean-800 text-center mb-2 sm:mb-3 px-2">
                      {feature.title}
                    </h3>
                    <div className="mt-auto text-ocean-600/80 text-center text-xs sm:text-sm font-medium">
                      Tap to explore
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute w-full h-full [backface-visibility:hidden] [transform:rotateY(180deg)]">
                  <div className="h-full p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-algae-500/95 to-teal-600/95 backdrop-blur-md rounded-lg sm:rounded-xl lg:rounded-2xl shadow-xl flex flex-col items-center justify-center">
                    <div className="flex-1 flex items-center">
                      <p className="text-xs sm:text-sm lg:text-base leading-relaxed text-center text-white/90 px-2">
                        {feature.description}
                      </p>
                    </div>
                    <button className="mt-3 sm:mt-4 lg:mt-6 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/20 hover:bg-white/30 rounded-lg backdrop-blur-sm transition-all duration-300 text-white font-medium hover:scale-105 hover:shadow-lg text-xs sm:text-sm">
                      Learn More
                    </button>
                  </div>
                </div>
