      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="reveal-on-scroll">
            ...
            <button className="bg-teal-600 text-white px-6 py-3 rounded-md text-lg font-semibold hover:bg-teal-700 transition-all duration-700 shadow-md hover:shadow-lg">
              Learn About Our Process
            </button>
          </div>
          <div className="relative">
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl reveal-on-scroll">
              <Image
            ...
            <div className="absolute -bottom-8 -left-8 w-64 h-64 rounded-lg bg-ocean-50 p-6 shadow-xl animate-fade-in delay-300">
              <div className="flex items-center space-x-3 mb-3">
                <div className="w-10 h-10 rounded-full bg-algae-500 flex items-center justify-center text-white">
                ...
                <h3 className="text-xl font-semibold text-ocean-800">Innovation</h3>
              </div>
              <p className="text-ocean-600">Patented bioprocessing technology converts algae into versatile packaging materials.</p>
            </div>
          </div>
        </div>
      </div>
