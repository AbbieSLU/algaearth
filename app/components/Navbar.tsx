...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-700 ${
      scrolled ? 'py-3 bg-gradient-to-r from-teal-900/95 via-ocean-900/95 to-teal-900/95 backdrop-blur-md shadow-xl' : 'py-6 bg-transparent'
    }`}>
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between">
          <Link 
            href="/" 
            className="flex items-center space-x-2 text-2xl font-bold text-white hover:text-algae-300 transition-colors duration-300 transform hover:scale-105"
          >
